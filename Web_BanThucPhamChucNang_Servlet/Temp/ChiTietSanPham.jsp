...
<body>
    ...
    <div class="humberger__menu__wrapper">
        ...
        <div class="humberger__menu__contact">
            <ul>
                <li><i class="fa fa-envelope"></i>vhong1092001@gmail.com</li>
            ...
            <div class="row">
                <div class="col-lg-3">
                    <div class="hero__categories">
                        ...
                        <ul>
                            <li><a href="#">Thuoc mat</a></li>
                            <li><a href="#">Thuoc tang chieu cao</a></li>
                            <li><a href="#">Thuoc giam can</a></li>
                            <li><a href="#">Thuoc bo sung vitamin</a></li>
                            <li><a href="#">Thuoc tang can</a></li>
                            <li><a href="#">Thuoc ngu</a></li>
                        </ul>
                    </div>
                </div>
                <div class="col-lg-9">
            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-md-6">
                    <div class="product__details__text">
                        ...
                        <div class="product__details__price"><%= sanPham.getGiaSp() %></div>
                        <p><%= sanPham.getMoTa() %></p> 
