...
<head>
    ...
    <title>Ogani | Thêm Sản Phẩm</title>
...
<% 
	List<NhaCungCap> lsNhaCungCaps = (List)request.getAttribute("lsNhaCungCaps");
%>
    ...
    <section class="checkout spad">
        <div class="container">           
            <div class="checkout__form">
                ...
                <form action="TrangChu_Servlet" method="post" enctype='multipart/form-data'>
                	<input type="hidden" name="command" value="LUUSANPHAM">           	
                    <div class="row">
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="checkout__input">
                                        ...
                                        <input name="giaSanPham" type="number">
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="checkout__input">
                                        <p>Lợi ích<span>*</span></p>
                                        <input name="loiIch" type="text">
                                    </div>
                                </div> 
                            </div> 
                             <div class="row">
                                    ...
                                    <div class="checkout__input">
	                                    ...
	                                    <select  id="loaiSanPhamDuoi" name="slLoaiSanPham">
		                                    ...
		                                    for(int i=0;i<dsLoai.length;i++){%>				                                    	                                  
											    <option><%=dsLoai[i].toString()%></option>										    											
											<%}%>
										</select>
	                                 </div>
	                                 <br>
                            ...
                            <div class="row">
	                            <div class="col-lg-6">
	                                <div class="checkout__input">
	                                    ...
	                                    <input name="doiTuongSuDung" type="text">
	                                </div>
	                            </div>
	                            <div class="col-lg-6">
	                                <div class="">
	                                    <p>image sản phẩm<span>*</span></p>
	                                    <input type="file" name="imgSanPham">
	                                </div>
	                            </div> 
                            </div> 
                            <div class="row">
                             ...
                             <div class="col-lg-12" align="center">     
					                 ...
					                 <script>
					                   function ThongBao(){		
					                 	  alert("Thêm san phẩm thành công"); 
					                   }
					             	</script>
