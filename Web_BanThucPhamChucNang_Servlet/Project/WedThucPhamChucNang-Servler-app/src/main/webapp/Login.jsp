...
<html lang="en">
    ...
    <jsp:include page="Menu.jsp"></jsp:include>
        ...
        <div id="logreg-forms">
            ...
            <form class="form-signin" action="TrangChu_Servlet" method="get">
            	<input type="hidden" name="command" value="DANGNHAP"/>
                <h1 class="h3 mb-3 font-weight-normal" style="text-align: center">Đăng Nhập</h1>  
                <input name="taiKhoan" value="${username}"  type="text" id="inputEmail" class="form-control" placeholder="Username" required="" autofocus="">
                <input name="matKhau" value="${password}" type="password" id="inputPassword" class="form-control" placeholder="Password" required="">
            ...
            <form action="TrangChu_Servlet" method="get" class="form-signup">
                <h1 class="h3 mb-3 font-weight-normal" style="text-align: center">Đăng ký tài khoản</h1>
                <input type="hidden" name="command" value="DANGKY"/>
                <input name="user" type="text" id="user-name" class="form-control" placeholder="User name" required="" autofocus="">
                <input name="pass" type="password" id="user-pass" class="form-control" placeholder="Password" required autofocus="">
                <input name="repass" type="password" id="user-repeatpass" class="form-control" placeholder="Nhập lại tài khoản" required autofocus="">
